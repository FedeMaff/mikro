...
* Mikro\Exceptions\FileReadException
*
* PHP version 7.4
*
* @category  Class
...
/**
* Implementazione concreta eccezione: "Lettura file fallita"
*
* @category  Class
* @package   Mikro
* @author    Federico Maffucci <m4ffucci@gmail.com>
*/
class FileReadException extends MikroException
{
   /**
    ...
    */
    protected string $title = 'Lettura file fallita';
